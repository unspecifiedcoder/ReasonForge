...
class SandboxExecutor:
    ...
    async def run_pytest(
        ...
        # Only sandbox the solution code.  The test file is generated by
        # ReasonForge and needs full standard-library access (pytest itself
        # uses pathlib, importlib, etc.).  The import hook in the solution
        # file prevents the *solution* from calling dangerous modules; the
        # test file imports the solution module which carries the hook.
        sandboxed_code = self._prepend_hook(code)
